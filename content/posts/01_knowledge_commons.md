---
title: "2019-04 Knowledge Commons"
...
# Data Together: Knowledge Commons (April 2019)

_Data Together is a community of people building a better future for data. We engage in a monthly [Reading Group](https://github.com/datatogether/reading_datatogether) on themes relevant to information and ethics. The theme for April 2019 was Knowledge Commons._

_This conversation takes place in a group of about a dozen people whose backgrounds include building decentralized web protocols and tools, archiving environmental data, academic research of ethical frameworks, community creation for citizen science, and more, with a lot of overlap._

_The group discussed the governance of commons more broadly [last year](https://github.com/datatogether/reading_datatogether/blob/master/notes/semester_01_2018/3-commons-2018-08-21.md). For this year's discussion, the group chose to revisit last semester’s ideas around governing the commons, but with more emphasis and focus on how knowledge, information, and digital data might be treated and governed as common pool resources._

_This blog post is derived from the conversation, but is not a replica of it; we rearrange and paraphrase throughout._
...
**ROB**: In defining a knowledge/digital commons, there seems to be a lot more variety than you might at base assume. There are much broader situations and baseline needs/concerns to address in different ways for different constituencies. Some patterns transfer from one project to another; others fail to do so. Software commons is unique. Data Together might share more with other knowledge repositories.
...
**MICHELLE**: From my work at Protocol Labs, it's often less valuable to define something as commons or not, and more valuable to explore how communities manage resources with externalities.

**LIZ**: In our decentralized data archiving project, we wondered about how communities define each other in order to set goals for access to data sharing. It's reasonable to approach that through **Ostrom's 8** and see where we get with respect to community self-regulation and structures to exclude and include. 

_The "Ostrom's 8" that Liz refers to are eight design principles of robust, long-enduring, common-pool resource institutions which Ostrom identifies (Ostrom, 7):_
...
**KEVIN**:  What about the tragedy of the anti-commons? With natural resources the problem is overuse, but the problem with the knowledge commons is that people underuse resources or don't add to them. **What incentives could we propose so they'd join and contribute?**
...
**BRENDAN**:  In our group here we have a lot of really colorful examples of constructing a commons. **Are social networks a commons?**

**MICHELLE** There's personal control of data that has gotten people mobilized. But it's so difficult to connect this to regular life. **I spent years in the federal government trying to get people submitting metadata to open data.** Will making tech easier be the thing that makes that happen?

**MATT**: It had better be easier than what already exists. It doesn't have to be better, it just has to be easier.

## Strategies for productive knowledge commoning & hope for the commons
**MICHELLE**: What do folks make that people don't hate to use? Where do we have ability to change rules around what the community wants and needs?

Few people have ability to make or change the rules that affect them. This is particularly true in the tech space. How do we change that?
...
**ROB**: Sustainability is a continual process. **What does sustainability mean in an environment [such as a digital commons] where the pace of change is extremely high?**
...
**BRENDAN**: Humans are irrational. We can't interpret the models in terms of a rational human. Hardin was responding to this model where humans were "econs", perfectly self-interested. But Ostrom refutes that quite simply because we already know now, in modern economics, that people do not always behave in self-interested ways.
...
We don't want to go all the way to the other end of the spectrum and connect folks with no common interests, but our opportunity is to put in effort at bringing diverse folks to the table _before_ starting.
...
---
See the [recorded call](https://www.youtube.com/watch?v=bW8BYVwVbuo&list=PLtsP3g9LafVv78TIa42xr591-4CfKMYQO&index=2&t=0s) for the full discussion!
